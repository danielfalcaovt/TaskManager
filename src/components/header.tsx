    ...
    <header>
      <div id="header-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="white" fill="none">
          <path d="M7.01428 16.0029H11.0143M7.01428 11.0053H15.0143" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M10.0143 21.9999H11.0143" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
